<?php 
	...
	function getTabURL($viewIndex = null){
		...
		return 'admin.php?page=site-exit-manager&amp;view=' . $viewIndex;
	}	
?>

<div id="thethefly">
  <div class="wrap">
    <h2 id="thethefly-panel-title"> <span id="thethefly-panel-icon" class="icon48">&nbsp;</span> TheThe Site Exit Manager</h2>
...
$tabDesc = '';
switch ($view) {
	case 'settings': $tabDesc = 'TheThe Site Exit Manager Settings';break;
	default: $tabDesc = 'TheThe Site Exit Manager Overview';
}?>
